...
function FoodSafetyCategoriesApp({ apiBase }) {
...
const root = document.getElementById('food-safety-categories-root');
if (root) {
  const apiBase = window.PAGE_CONFIG.apiBase;
  ReactDOM.createRoot(root).render(<FoodSafetyCategoriesApp apiBase={apiBase} />);
}
